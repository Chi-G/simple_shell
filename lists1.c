...
/**
 * list_len - it determines the  length of the linked list
...
/**
 * print_list - it prints all the elemnts of a list_t linked list
...
/**
 * node_starts_with - it returns node whose string startsvwith prefix
