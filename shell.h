...
/**
 * struct passinfo - contains pseudo-args to pass into a function,
 * allowing uniform prototype for function pointer struct
 * @arg: a string generated from getline containing args
 * @argv: an array of strings generated from arg
 * @path: a sring path fro the current command
 * @argc: the arg count
 ...
 * @status: the return status of the last exec's command
